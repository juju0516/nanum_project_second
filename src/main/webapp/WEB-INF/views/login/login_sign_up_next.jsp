...
<script type="text/javascript">
	function sendSignUpNext(f) {
		
		f.action = "login_sign_up_final.do";
		f.submit();
...
<link
	...
	rel="stylesheet">
<link href="resources/css/sign_up_next.css" type="text/css"
	rel="stylesheet">
</head>
<body>
				...
				<form method="post">
					<div class="member_info">
						<table class="member_info_table">
							<tr>
								<td>닉네임:</td>
								<td><input type="text" id="nickname" name="nickname" for="nickname"
									placeholder="닉네임을 입력하세요"></td>
							</tr>
							<tr>
								<td>주소:</td>
								<td><input type="text" id="sample3_postcode" name="sample3_postcode"
									placeholder="우편번호"></td>
							...
							<tr>
								<td>&nbsp;</td>
								<td><input type="text" id="sample3_address" name="sample3_address"
									placeholder="주소"></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td><input type="text" id="sample3_detailAddress" name="sample3_detailAddress"
									placeholder="상세주소"></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td><input type="text" id="sample3_extraAddress" name="sample3_extraAddress"
									placeholder="참고항목"></td>
							</tr>
							<div id="wrap"
					...
					<div class="next">
						<!--<a href="login_sign_up_final.do"><button class="next_btn"
							onclick="">넘어가기</button></a>  -->
						<input type="hidden" name="id" value="${id}">
						<input type="button" value="넘어가기" class="next_btn"
							onclick="sendSignUpNext(this.form)">
					</div>
				</form>
				</section>
